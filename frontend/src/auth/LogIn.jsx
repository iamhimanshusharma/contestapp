            ...
            <div className="flex-1 flex flex-col items-center justify-center p-4">
                <div className="w-full max-w-[400px] bg-white dark:bg-[#282828] rounded-lg p-6 sm:p-8 shadow-sm border border-transparent dark:border-[#333]">
                    ...
                    <div className="flex justify-between items-center mt-6 text-sm">
                        <span className="text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 cursor-pointer">Forgot Password?</span>
                        <NavLink to="/signin" className="text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200">Sign Up</NavLink>
                    </div>
                    ...
                    {/* <div className="relative mt-6 mb-4">
                        ...
                        <div className="relative flex justify-center text-xs">
                            <span className="px-3 bg-white dark:bg-[#282828] text-gray-400">or you can sign in with</span>
                        </div>
                    </div>
