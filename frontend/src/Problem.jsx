...
const RightSidebar = () => (
    <div className="w-[270px] hidden xl:flex flex-col gap-6 flex-shrink-0 sticky top-20 self-start">
...
const PromoCards = () => (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
        <div className="h-32 rounded-xl bg-gradient-to-r from-[#0d1021] to-[#1a1b3c] border border-[#2a2c4c] flex flex-col items-center justify-center p-4 relative overflow-hidden group cursor-pointer shadow-sm">
            ...
            <h3 className="text-white font-bold text-lg text-center z-10">ContestApp at Your Fingertips</h3>
        </div>
        <div className="h-32 rounded-xl bg-gradient-to-r from-[#174836] to-[#257356] border border-[#30916d] p-5 relative overflow-hidden group cursor-pointer shadow-sm flex flex-col justify-center">
            <h3 className="text-white font-bold text-xl leading-tight mb-1 relative z-10">Banner One</h3>
            <p className="text-emerald-100/80 text-xs font-medium relative z-10 w-3/4">Banner One Description</p>
        </div>
        <div className="h-32 rounded-xl bg-gradient-to-br from-[#7748ff] to-[#592ede] border border-[#8a5fff] p-5 relative overflow-hidden group cursor-pointer hidden lg:flex flex-col justify-center shadow-sm">
            <h3 className="text-white font-bold text-xl leading-tight mb-1 relative z-10">Banner Two</h3>
            <p className="text-purple-200/90 text-xs font-medium relative z-10">Banner Two Description</p>
        </div>
    </div>
);
                ...
                <div className="flex-1 flex flex-col min-w-0">
                    ...
                    <div className="flex items-start flex-wrap gap-2 mb-5">
                        ...
                        <span
                            ...
                            className={`inline-flex items-center px-3 py-1.5 rounded-full border text-xs font-medium cursor-pointer transition-colors shadow-sm ${activeTag === null
                        ...
                        {tagsToShow.map((topic, i) => (
                            <span
                                ...
                                className={`inline-flex items-center px-3 py-1.5 rounded-full border text-xs font-medium cursor-pointer transition-colors shadow-sm ${activeTag === topic
                                    ? 'bg-[#ffa116] text-white border-[#ffa116]'
                                    : 'bg-white dark:bg-[#282828] border-gray-200 dark:border-transparent text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-[#333]'
                                    }`}
                            >
