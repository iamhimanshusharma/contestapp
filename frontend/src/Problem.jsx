...
import {
    ...
    List, TrendingUp, Coins, ShoppingBag, Gamepad2, Palette, LogOut
} from "lucide-react";
...
const Problem = () => {
    ...
    const { isAuthenticated, user, logout, theme } = useAuth();
                ...
                <div className="flex items-center justify-end gap-4 flex-1">
                    ...
                    {user ? (
                        <div className="relative" ref={avatarRef}>
                            ...
                            {avatarOpen && (
                                <div className="absolute top-9 right-0 w-68 bg-[#1e1e1e] border border-[#333] rounded-xl shadow-2xl z-[200] overflow-y-auto animate-fade-in-down" style={{ width: 272, maxHeight: 'calc(100vh - 60px)' }}>
                                    <button
                                    ...
                                    <div className="grid grid-cols-4 gap-2 px-3 py-3 border-b border-[#2a2a2a]">
                                        {[
                                            { icon: <List size={17} className="text-orange-400" />, label: 'My Lists', bg: 'bg-[#3a3a3a]' },
                                            { icon: <BookOpen size={17} className="text-blue-400" />, label: 'Notebook', bg: 'bg-[#3a3a3a]' },
                                            { icon: <TrendingUp size={17} className="text-green-400" />, label: 'Progress', bg: 'bg-[#3a3a3a]' },
                    ...
                    <button className="hidden sm:block px-3 py-1.5 bg-[#ffa116]/10 text-[#ffa116] hover:bg-[#ffa116]/20 rounded text-xs font-semibold transition-colors">Premium</button>
                </div>
            </div>
